...
module.exports={name:"wacoq-bin",version:"0.12.1-alpha1",description:"WASM Binaries of the Coq Proof Assistant (for jsCoq)",main:"dist/index.html",author:"corwin-of-amber",license:"ISC",scripts:{build:"parcel build src/worker.ts && etc/build-node.sh",postinstall:"node ./etc/postinstall.js"},bin:{wacoq:"./index.js"},dependencies:{"@ocaml-wasm/4.08--num":"^1.4.0","array-equal":"^1.0.0",byline:"^5.0.0",commander:"^5.1.0",fflate:"^0.3.6",find:"^0.3.0","find-up":"^5.0.0",jquery:"^3.5.1",jszip:"^3.5.0","jszip-unzip":"^3.4.0-0",mkdirp:"^1.0.4",neatjson:"^0.8.3","ocaml-wasm":"4.8.1-3","wasi-kernel":"^0.1.1-rc1"},devDependencies:{"@types/find":"^0.2.1","@types/jquery":"^3.5.0","@types/mkdirp":"^1.0.1","@types/node":"^14.0.27",cssnano:"^4.1.10",typescript:"^3.9.7"},bundledDependencies:["jszip","neatjson"],browserslist:["Chrome 78"]};
...
},{"./fsif":"anFH","./project":"kdub"}],"FQSP":[function(require,module,exports) {
var t=null;function e(){return t||(t=n()),t}function n(){try{throw new Error}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|chrome-extension|moz-extension):\/\/[^)\n]+/g);if(t)return r(t[0])}return"/"}function r(t){return(""+t).replace(/^((?:https?|file|ftp|chrome-extension|moz-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}exports.getBundleURL=e,exports.getBaseURL=r;
},{}],"ZQm6":[function(require,module,exports) {
...
},{"./bundle-url":"FQSP"}],"kdub":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.JsCoqCompat=exports.ZipVolume=exports.InMemoryVolume=exports.ModuleIndex=exports.SearchPath=exports.CoqProject=void 0;var e=require("./fsif"),t=require("./coqdep"),s=l(require("array-equal")),i=require("fflate"),r=require("neatjson"),o=l(require("fs")),a=l(require("path"));function l(e){return e&&e.__esModule?e:{default:e}}function n(e,t){var s=Object.keys(e);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);t&&(i=i.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),s.push.apply(s,i)}return s}function c(e){for(var t=1;t<arguments.length;t++){var s=null!=arguments[t]?arguments[t]:{};t%2?n(Object(s),!0).forEach(function(t){h(e,t,s[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(s)):n(Object(s)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(s,t))})}return e}function h(e,t,s){return t in e?Object.defineProperty(e,t,{value:s,enumerable:!0,configurable:!0,writable:!0}):e[t]=s,e}class u{constructor(t,s=e.fsif_native){this.volume=s,this.name=t,this.deps=[],this.searchPath=new f(s),this.opts={json:{padding:1,afterColon:1,afterComma:1,wrap:80},zip:{}}}fromJson(e,t="",s=this.volume){for(let l in e){var i=this.toDirPath(e[l].prefix||"");for(let n of e[l].dirpaths||[""]){var r=this.toDirPath(n),o=s.path.join(t,l,...r),a={volume:s,physical:o,logical:i.concat(r),pkg:this.name};"string"==typeof n||n.rec?this.searchPath.addRecursive(a):this.searchPath.add(a)}}return this}fromDirectory(e="",t=this.volume){return this.searchPath.addRecursive({volume:t,physical:e,logical:"",pkg:this.name}),this}setModules(e){this._modules=e.map(e=>"string"==typeof e?{volume:this.volume,physical:e,logical:this.searchPath.toLogical(e),pkg:this.name}:e)}computeDeps(){var e=new t.CoqDep;return e.searchPath=this.searchPath,e.processModules(this.modules()),e}modules(){return this._modules||this.searchPath.modulesOf(this.name)}modulesByExt(e){return this.modulesByExts([e])}*modulesByExts(e){for(let t of this.modules())e.some(e=>t.physical.endsWith(e))&&(yield t)}listModules(){return this.searchPath._listNames(this.modules())}createManifest(){var e=this.computeDeps().depsToJson(),t={};for(let s of this.listModules())t[s]=e[s]?{deps:e[s]}:{};return{name:this.name,deps:this.deps,modules:t}}toDirPath(e){return this.searchPath.toDirPath("string"==typeof e?e:e.logical)}copyLogical(e=new v){for(let{volume:t,physical:s,logical:i}of this.modulesByExt(".v"))e.fs.writeFileSync(`/${i.join("/")}.v`,t.fs.readFileSync(s));return new u(this.name,e).fromDirectory("/")}async toZip(e,t=[".vo",".cma"],s=(e=>[e])){var i=new p(this.opts.zip);e&&i.writeFileSync("coq-pkg.json",e);for(let a of this.modulesByExts(t))for(let e of s(a)){var r=e.ext||e.physical.match(/[.][^.]+$/)[0];try{i.writeFileSync(e.logical.join("/")+r,e.payload||e.volume.fs.readFileSync(e.physical))}catch(o){console.warn(`skipped ${e.physical} (${o})`)}}return i}async toPackage(e=this.name,t,s=(e=>[e]),i=(e=>e)){e.match(/[.][^./]+$/)||(e+=".coq-pkg");var o=i(this.createManifest(),e),a=e.replace(/[.][^./]+$/,".json"),l=(0,r.neatJSON)(o,this.opts.json);return new d({filename:e,zip:await this.toZip(l,t,s)},{filename:a,json:l,object:o})}}exports.CoqProject=u;class p{constructor(e){this.z={},this.opts=e}writeFileSync(e,t){"string"==typeof t&&(t=(new TextEncoder).encode(t)),this.z[e]=t}zipSync(){return(0,i.zipSync)(this.z)}}class d{constructor(e,t){this.pkg=e,this.manifest=t}async save(e){const t=require("mkdirp").sync;return t(a.default.dirname(this.pkg.filename)),e?(e.chunks||(e.chunks=[]),e.chunks.push(this.manifest.object)):(t(a.default.dirname(this.manifest.filename)),o.default.writeFileSync(this.manifest.filename,this.manifest.json)),o.default.writeFileSync(this.pkg.filename,this.pkg.zip.zipSync()),this}}class f{constructor(t=e.fsif_native){this.volume=t,this.path=[]}add({volume:e,physical:t,logical:s,pkg:i}){e=e||this.volume,s=this.toDirPath(s),this.path.push({volume:e,logical:s,physical:t,pkg:i})}addRecursive({volume:e,physical:t,logical:s,pkg:i}){e=e||this.volume,s=this.toDirPath(s),this.add({volume:e,physical:t,logical:s,pkg:i});for(let o of e.fs.readdirSync(t)){var r=e.path.join(t,o);e.fs.statSync(r).isDirectory()&&this.addRecursive({volume:e,physical:r,logical:s.concat([o]),pkg:i})}}addFrom(e){e instanceof u&&(e=e.searchPath),this.path.push(...e.path)}toLogical(e){var t=this.volume.path.dirname(e),s=this.volume.path.basename(e).replace(/[.]vo?$/,"");for(let{logical:i,physical:r}of this.path)if(r===t)return i.concat([s])}toDirPath(e){return"string"==typeof e?e.split(".").filter(e=>e):e}*modules(){for(let{volume:e,logical:t,physical:s,pkg:i}of this.path)for(let r of e.fs.readdirSync(s))if(r.match(/[.](vo?|cma)$/)){let o=r.replace(/[.](vo?|cma)$/,""),a=e.path.join(s,r);yield{volume:e,logical:t.concat([o]),physical:a,pkg:i}}}*modulesOf(e){for(let t of this.modules())t.pkg===e&&(yield t)}listModules(){return this._listNames(this.modules())}listModulesOf(e){return this._listNames(this.modulesOf(e))}_listNames(e){let t=new Set,s=e=>e.logical.join(".");for(let i of e)t.add(s(i));return t}*findModules(e,t,s=!1){yield*this.moduleIndex?this.moduleIndex.findModules(e,t,s):this._findModules(e,t,s),yield*this._findExtern(e,t,s)}*_findModules(e,t,i=!1){var r=this.toDirPath(e)||[],o=this.toDirPath(t);let a=i?e=>(0,s.default)(e,r.concat(o)):e=>((e,t)=>(0,s.default)(e.slice(0,t.length),t))(e,r)&&((e,t)=>0==t.length||(0,s.default)(e.slice(-t.length),t))(e,o);for(let s of this.modules())a(s.logical)&&(yield s)}*_findExtern(e,t,s=!1){if(this.packageIndex)for(let i of this.packageIndex.findModules(e,t,s))yield{volume:null,physical:null,logical:i.split("."),pkg:"+"}}createIndex(){this.moduleIndex=new m;for(let e of this.modules())this.moduleIndex.add(e);return this.moduleIndex}}exports.SearchPath=f;class m{constructor(){this.index=new Map}add(e){this.index.set((e=>e.logical.join("."))(e),e)}*findModules(e,t,s=!1){if(Array.isArray(e)&&(e=e.join(".")),Array.isArray(t)&&(t=t.join(".")),e=e?e+".":"",s){var i=this.index.get(e+t);i&&(yield i)}else{var r="."+t;for(let[s,i]of this.index.entries())s.startsWith(e)&&(s==t||s.endsWith(r))&&(yield i)}}}exports.ModuleIndex=m;class y{constructor(){this.fs=this,this.path=e.fsif_native.path}readdirSync(e){let t=[];""===e||e.endsWith("/")||(e+="/");for(let i of this._files)if(i.startsWith(e)){var s=i.substring(e.length).split("/").filter(e=>e);s[0]&&!t.includes(s[0])&&t.push(s[0])}return t}statSync(e){var t=e.replace(/(^|([^/]))$/,"$2/");for(let s of this._files)if(s.startsWith(t))return{isDirectory:()=>!0};throw new Error(`ENOENT: '${e}'`)}}class v extends y{constructor(){super(),this.fileMap=new Map}get _files(){return this.fileMap.keys()}writeFileSync(e,t){"string"==typeof t&&(t=(new TextEncoder).encode(t)),this.fileMap.set(e,t)}readFileSync(e,t){var s=this.fileMap.get(e);if(s)return t?(new TextDecoder).decode(s):s;throw new Error(`ENOENT: '${e}'`)}statSync(e){return this.fileMap.get(e)?{isDirectory:()=>!1}:super.statSync(e)}}exports.InMemoryVolume=v;class g extends y{constructor(e){super(),this.zip=e,this._files=[],this.zip.forEach(e=>this._files.push(e))}readFileSync(e,t){var s=this.zip.files[e];if(s)return this._inflateSync(s);throw new Error(`ENOENT: ${e}`)}statSync(e){var t=this.zip.files[e]||this.zip.files[e+"/"];return t?{isDirectory:()=>t&&t.dir}:super.statSync(e)}static async fromFile(e){const t=await require("_bundle_loader")(require.resolve("jszip"));return new g(await t.loadAsync((0,o.default.readFileSync)(e)))}static async fromBlob(e){const t=await require("_bundle_loader")(require.resolve("jszip"));return new g(await t.loadAsync(e))}_inflateSync(e){const{DEFLATE:t}=require("jszip/lib/compressions"),{inflateRaw:s}=require("pako");return e._data.compression==t?s(e._data.compressedContent):e._data.compressedContent}}exports.ZipVolume=g;class w{static transpilePluginsJs(e){if(e.physical.endsWith(".cma")){const t=require("child_process"),s=e.physical,i=`${s}.js`;return t.execSync(`js_of_ocaml --wrap-with-fun= -o ${i} ${s}`),[c(c({},e),{},{payload:new Uint8Array}),c(c({},e),{},{physical:i,ext:".cma.js"})]}return[e]}static backportManifest(e,t){var s={};for(let a in e.modules){var[i,r]=a.split(/[.]([^.]+)$/);(s[i]=s[i]||[]).push(r)}var o=Object.entries(s).map(([e,t])=>({pkg_id:e.split("."),vo_files:t.map(e=>[`${e}.vo`,null]),cma_files:[]})),l={};for(let a in e.modules){var n=e.modules[a].deps;n&&(l[a]=n)}var c=e.archive||t&&a.default.basename(t);return{desc:e.name,deps:e.deps||[],archive:c,pkgs:o,modDeps:l}}}exports.JsCoqCompat=w;
},{"./fsif":"anFH","./coqdep":"wpVs","_bundle_loader":"ZQm6"}],"OJcE":[function(require,module,exports) {
