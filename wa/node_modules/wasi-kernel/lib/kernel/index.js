...
},{"./bits/queue":"GjP7"}],"fQPE":[function(require,module,exports) {
...
},{"../../infra/arch":"nTzI"}],"VYPn":[function(require,module,exports) {
var t=null;function e(){return t||(t=n()),t}function n(){try{throw new Error}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|chrome-extension|moz-extension):\/\/[^)\n]+/g);if(t)return r(t[0])}return"/"}function r(t){return(""+t).replace(/^((?:https?|file|ftp|chrome-extension|moz-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}exports.getBundleURL=e,exports.getBaseURL=r;
},{}],"wtCR":[function(require,module,exports) {
...
},{"./bundle-url":"VYPn"}],"DocZ":[function(require,module,exports) {
...
},{}],"myEq":[function(require,module,exports) {
...
},{"./streams":"YPBo","./bits/tty":"DocZ","./bits/proc":"SKKL","./bindings/utf8":"myEq","../infra/arch":"nTzI"}],"ItXb":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.BareProcess=exports.WorkerProcess=exports.ProcessBase=void 0;var e=require("events"),t=require("./streams"),r=require("./bits/proc"),s=require("./bindings/workers"),i=require("./bits/queue");function o(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(e);t&&(s=s.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,s)}return r}function n(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{};t%2?o(Object(r),!0).forEach(function(t){a(e,t,r[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):o(Object(r)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(r,t))})}return e}function a(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}class c extends e.EventEmitter{constructor(e){super(),this.opts=e,this.setupEncoder()?this.stdout=new t.TransformStreamDuplex(new TextDecoderStream):"undefined"!=typeof process&&process.stdin&&(process.stdin.on("data",e=>this.stdin_raw.write(e)),this.stdout=process.stdout),this.on("exit",()=>this.exited=!0)}waitFor(){var e,t;return new Promise((r,s)=>{this.on("error",e=(e=>s(e))),this.on("exit",t=(e=>r(e)))}).finally(()=>{this.removeListener("error",e),this.removeListener("exit",t)})}reset(){this.exited=!1,this.stdin_raw.reset(),this.setupEncoder()}setupEncoder(){return"undefined"!=typeof TextEncoderStream&&(this.stdin=new t.TransformStreamDuplex(new TextEncoderStream),this.stdin.on("data",e=>this.stdin_raw.write(e)),this.stdin.on("end",()=>this.stdin_raw.end()),!0)}}exports.ProcessBase=c;class d extends c{constructor(e,o={}){super(o),this.worker=new s.Worker("/worker.e2e0f3d9.js"),this.worker.addEventListener("message",s=>{s.data.stdin&&(this.stdin_raw=t.SimplexStream.from(s.data.stdin)),s.data.tty&&(this.tty=s.data.tty),s.data.sigvec&&(this.sigvec=r.SignalVector.from(s.data.sigvec)),s.data.childq&&(this.childq=i.SharedQueue.from(s.data.childq)),s.data.fd&&this.stdout.write(s.data.data),s.data.event&&this.emit(s.data.event,s.data.arg,e)}),e&&this.exec(e)}mountFs(e){return this.worker.postMessage({volume:e.to()}),this}exec(e,t){this.exited&&this.reset(),t&&(this.opts.argv=t),this.worker.postMessage({exec:e,opts:this.opts})}}exports.WorkerProcess=d;class u extends c{constructor(e,t={}){super(t),this.exec(e)}async exec(e,t){const{ExecCore:r}=await require("_bundle_loader")(require.resolve("./exec"));this.core=new r(n({argv:t},this.opts)),this.core.on("stream:out",e=>process.stdout.write(e.data));try{let t=await this.core.start(e,this.opts.argv);this.emit("exit",{code:t})}catch(s){this.emit("error",s,e)}}}exports.BareProcess=u;
},{"./streams":"YPBo","./bits/proc":"SKKL","./bindings/workers":"kuzr","./bits/queue":"GjP7","./worker.ts":[["worker.e2e0f3d9.js","ZXZ8"],"worker.e2e0f3d9.js.map","ZXZ8"],"_bundle_loader":"wtCR","./exec":[["index.js","QCba"],"index.js.map","jUBY"]}],"IYPW":[function(require,module,exports) {
...
},{"./process":"ItXb","./exec":"jUBY","./services/shared-fs":"IYPW"}],"wEgY":[function(require,module,exports) {
...
var b=require("wtCR");b.register("js",require("wEgY"));
},{}]},{},[0,"QCba"], null)
